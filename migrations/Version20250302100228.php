 ...
 */
final class Version20250302100228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE like_dislike (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, is_like TINYINT(1) NOT NULL, user_identifier VARCHAR(255) NOT NULL, INDEX IDX_ADB6A6897294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, tel VARCHAR(20) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A66B899279 FOREIGN KEY (patient_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A616E8FB6D FOREIGN KEY (psychiatrist_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE like_dislike ADD CONSTRAINT FK_ADB6A6897294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE');
