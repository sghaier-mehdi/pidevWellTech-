...
public class ConsultationEditController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (currentUser.getRole() == UserRole.PATIENT) {
            ...
            if (!isEditMode) {
                ...
                if (currentConsultation.getPsychiatrist() == null || currentConsultation.getPsychiatrist().getId() != currentUser.getId() && currentUser.getRole() != UserRole.ADMIN) {
            ...
            patientComboBox.setDisable(currentUser.getRole() != UserRole.ADMIN && isEditMode);
            psychiatristComboBox.setDisable(currentUser.getRole() != UserRole.ADMIN && isEditMode);
        }
    ...
    private boolean validateForm() {
        ...
        if (patientComboBox.getValue() == null) {
            ...
            isValid = false;
        } else if (patientComboBox.getValue().getRole() != UserRole.PATIENT) {
        ...
        if (psychiatristComboBox.getValue() == null) {
            ...
            isValid = false;
        } else if (psychiatristComboBox.getValue().getRole() != UserRole.PSYCHIATRIST && psychiatristComboBox.getValue().getRole() != UserRole.ADMIN) {
